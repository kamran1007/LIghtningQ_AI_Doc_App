...
@Module({
  ...
  providers: [PatientcareService,ManagePatientService, AppointmentService ,PrismaService,MailerService,ConsultationService,DashboardService,WhatsappService,R2Service],
