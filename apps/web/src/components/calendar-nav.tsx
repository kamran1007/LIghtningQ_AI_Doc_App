  ...
  return (
    <div className="flex flex-wrap min-w-full justify-center gap-3 px-10 ">
      <div className="flex flex-row space-x-1">
        ...
        <Button
          variant="ghost"
          className="w-8 border-gray-300 focus:ring-0 focus:border-white  hover:bg-gray-100"
          onClick={() => {
            goPrev(calendarRef);
          }}
        >
          ...
          <Popover open={daySelectOpen} onOpenChange={setDaySelectOpen}>
            <PopoverTrigger asChild>
              <Button
                variant="outline"
                role="combobox"
                className="w-20 justify-between text-xs font-semibold border-gray-300 focus:ring-0 focus:border-white hover:bg-gray-100"
              >
                {selectedDay
            ...
            <PopoverContent className="w-[200px] p-0 border-gray-300 focus:ring-0 focus:border-white shadow-2xl hover:bg-gray-100 rounded-2xl">
              <Command>
        ...
        <Popover open={monthSelectOpen} onOpenChange={setMonthSelectOpen}>
          <PopoverTrigger asChild>
            <Button
              variant="outline"
              role="combobox"
              className="flex w-[105px] justify-between overflow-hidden p-2 text-xs font-semibold md:text-sm md:w-[120px] border-gray-300 focus:ring-0 focus:border-white  hover:bg-gray-100"
            >
              {selectedMonth
          ...
          <PopoverContent className="w-[200px] p-0 border-gray-300 focus:ring-0 focus:border-white shadow-xl hover:bg-gray-100">
            <Command>
        ...
        <Input
          className="w-[75px] md:w-[85px] text-xs md:text-sm font-semibold border-gray-300 focus:ring-0 focus:border-white  hover:bg-gray-100"
          type="number"
          value={selectedYear}
      ...
      <div className="flex flex-wrap gap-3 justify-center">
        ...
        <Button
          className="w-[90px] text-xs md:text-sm border  border-gray-300 focus:ring-0 focus:border-white  hover:bg-gray-100"
          variant="outline"
          onClick={() => {
            goToday(calendarRef);
          }}
