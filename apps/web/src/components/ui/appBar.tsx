...
const AppBar = async () => {
  ...
  return (
    <div className="navbar flex items-center justify-between px-4 py-2 h-14 relative bg-gray-800">
      ...
      <div className="absolute right-4 top-0 h-14 flex items-center gap-2 z-50">
        <p className="font-houschka text-2xl text-white whitespace-nowrap">
